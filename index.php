    ...
    <body>
        ...
        <div class="wrapper">
                ...
                <div class="row">
                    <div class="small-12 columns">
                        ...
                        <table class="table">
                            <tr>
                                <td>Time</td>
                                <td>9.00AM onwards</td>
                            </tr>
                            <tr>
                                <td>Date</td>
                                <td>4th & 5th December</td>
                            </tr>
                            <tr>
                                <td>Venue</td>
                                <td>Don Bosco College Panjim</td>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <div id="chat">
                <div class="row">
                    <div class="small-12 columns">
                        ...
                        <div id="tlkio" data-channel="meteora2014" style="width:100%;height:400px;"></div><script async src="http://tlk.io/embed.js" type="text/javascript"></script>
                    </div>
                </div>
            </div>
            ...
            <div id="committee">
                ...
                <div class="row">
                    <div class="small-12 columns">
                        <h1 class="title">Meteora Committe</h1>


                        <p class="quote">
                            Got Any Questions? Contact us Now.
                            <!--<q>&#8220;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque dolores eveniet illum ipsum libero neque.&#8221;</q>-->
                        </p>
